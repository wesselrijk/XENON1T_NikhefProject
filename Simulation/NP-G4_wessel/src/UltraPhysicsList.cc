           ...
           fMaxNumPhotonStep(20)
{
  ...
  // fOpPhysicsList.SetWLSTimeProfile("delta");

  // fOpPhysicsList.SetScintillationYieldFactor(1.0);
  // fOpPhysicsList.SetScintillationExcitationRatio(0.0);

  // fOpPhysicsList.SetMaxNumPhotonsPerStep(100);
  // fOpPhysicsList.SetMaxBetaChangePerStep(10.0);

  // fOpPhysicsList.SetTrackSecondariesFirst(kCerenkov, true);
  // fOpPhysicsList.SetTrackSecondariesFirst(kScintillation, true);
